...
//take picture, x and y coordinates of curr_position, x and y coordinates of destination, and color of board
//the picture at curr_position is replaced with a black/white tile
	if(color == 1){
		placePiece("Black_Title.bmp", xCurr, yCurr);
	}
	else{
		placePiece("White_Title.bmp", xCurr, yCurr);
	}
